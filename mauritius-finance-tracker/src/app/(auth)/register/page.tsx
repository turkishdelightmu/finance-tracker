    ...
    <div className="space-y-4">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          ...
          />
          {fieldErrors.name && (
            <p className="text-xs text-rose-300 mt-1">{fieldErrors.name}</p>
          )}
        </div>
        <div>
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full rounded-xl bg-gradient-to-r from-emerald-500 to-green-400 py-2 font-semibold text-white"
        >
      ...
      <p className="text-sm text-slate-300">
        ...
        <a className="font-medium text-white" href="/login">
          Sign in
        </a>
      </p>
    </div>
